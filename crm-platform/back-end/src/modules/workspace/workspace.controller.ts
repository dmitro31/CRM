...
export class WorkspaceController {
  ...
  @Get(':id')
  findOne(@Param('id') workspaceId: string, @CurrentUser() user: User) {
  ...
  update(
    ...
    return this.workspaceService.update(workspaceId, user.id, dto);
  }

  @Delete(':id')
  remove(@Param('id') workspaceId: string, @CurrentUser() user: User) {
