...
const variantClasses: Record<Variant, string> = {
  primary:
    'bg-[#24493B] text-white hover:bg-[#1B392E] disabled:opacity-50',
  secondary:
    'border border-[#DFE3DC] bg-white text-[#171A18] hover:border-[#C7CDC2] hover:bg-[#F6F7F4] disabled:opacity-50',
  ghost:
    'text-[#3D423B] hover:bg-[#EEF0EB] disabled:opacity-50',
  danger:
    'text-[#B3261E] hover:bg-[#FBEDEC] disabled:opacity-50',
}
